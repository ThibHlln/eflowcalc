...
htmlhelp_basename = 'eflowcalcdoc'
...
html_baseurl = 'https://thibhlln.github.io/eflowcalc'

html_favicon = '../_doc_img/eflowcalc-favicon.ico'

html_permalinks_icon = '<span class="fa fa-link">'

html_theme_options = {
    "logo": {
        "image_light": "eflowcalc-logo-light.svg",
        "image_dark": "eflowcalc-logo-dark.svg",
    },
    "icon_links": [
        {
            "name": "GitHub",
